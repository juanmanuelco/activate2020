<div>
    ...
    <div class="progress fixed-top" style="height: 8px; background-color: var(--background)">
        <div class="progress-bar progress-bar-striped bg-primary" id="progress_nav" role="progressbar" style="width: 0%; " aria-valuemin="0" aria-valuemax="100"></div>
    </div>
</div>
